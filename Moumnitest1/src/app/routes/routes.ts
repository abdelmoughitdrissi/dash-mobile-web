...
import { CurrenciesComponent } from './restaurant/currencies/currencies.component';
import { AddCurrencyComponent } from './restaurant/currencies/add-currency/add-currency.component';
import { EditCurrencyComponent } from './restaurant/currencies/edit-currency/edit-currency.component';
...

    {
        ...
        children: [
            ...
            },
            {
                path: 'currencies',
                children: [
                    { path: 'manageCurrency', component: CurrenciesComponent, canActivate: [AuthService] },
                    { path: 'addCurrency', component: AddCurrencyComponent, canActivate: [AuthService] },
                    { path: 'editCurrency/:id', component: EditCurrencyComponent, canActivate: [AuthService] }
